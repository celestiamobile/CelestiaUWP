...
namespace winrt::CelestiaComponent::implementation
{
    ...
    struct CelestiaAppCore : CelestiaAppCoreT<CelestiaAppCore>
    {
        ...
        bool StartRenderer(bool srgbRendering, int32_t shadowMapSize);
        void Tick();
        void Draw();
        ...
        void Perform(CelestiaComponent::CelestiaAction action);
        ...
        bool ShowTholusLabels();
        void ShowTholusLabels(bool showTholusLabels);
        bool ShowInsulaLabels();
        void ShowInsulaLabels(bool showInsulaLabels);
        bool ShowAlbedoLabels();
        void ShowAlbedoLabels(bool showAlbedoLabels);
        bool ShowArcusLabels();
        void ShowArcusLabels(bool showArcusLabels);
        bool ShowCavusLabels();
        void ShowCavusLabels(bool showCavusLabels);
        bool ShowCollesLabels();
        void ShowCollesLabels(bool showCollesLabels);
        bool ShowFaculaLabels();
        void ShowFaculaLabels(bool showFaculaLabels);
        bool ShowFlexusLabels();
        void ShowFlexusLabels(bool showFlexusLabels);
        bool ShowFlumenLabels();
        void ShowFlumenLabels(bool showFlumenLabels);
        bool ShowFretumLabels();
        void ShowFretumLabels(bool showFretumLabels);
        bool ShowLabesLabels();
        void ShowLabesLabels(bool showLabesLabels);
        bool ShowLabyrinthusLabels();
        void ShowLabyrinthusLabels(bool showLabyrinthusLabels);
        bool ShowLacunaLabels();
        void ShowLacunaLabels(bool showLacunaLabels);
        bool ShowLacusLabels();
        void ShowLacusLabels(bool showLacusLabels);
        bool ShowLargeRingedLabels();
        void ShowLargeRingedLabels(bool showLargeRingedLabels);
        bool ShowLobusLabels();
        void ShowLobusLabels(bool showLobusLabels);
        bool ShowLingulaLabels();
        void ShowLingulaLabels(bool showLingulaLabels);
        bool ShowMaculaLabels();
        void ShowMaculaLabels(bool showMaculaLabels);
        bool ShowOceanusLabels();
        void ShowOceanusLabels(bool showOceanusLabels);
        bool ShowPalusLabels();
        void ShowPalusLabels(bool showPalusLabels);
        bool ShowPlumeLabels();
        void ShowPlumeLabels(bool showPlumeLabels);
        bool ShowPromontoriumLabels();
        void ShowPromontoriumLabels(bool showPromontoriumLabels);
        bool ShowSatelliteLabels();
        void ShowSatelliteLabels(bool showSatelliteLabels);
        bool ShowScopulusLabels();
        void ShowScopulusLabels(bool showScopulusLabels);
        bool ShowSerpensLabels();
        void ShowSerpensLabels(bool showSerpensLabels);
        bool ShowSinusLabels();
        void ShowSinusLabels(bool showSinusLabels);
        bool ShowSulcusLabels();
        void ShowSulcusLabels(bool showSulcusLabels);
        bool ShowVastitasLabels();
        void ShowVastitasLabels(bool showVastitasLabels);
        bool ShowVirgaLabels();
        void ShowVirgaLabels(bool showVirgaLabels);
        bool ShowSaxumLabels();
        void ShowSaxumLabels(bool showSaxumLabels);
        bool ShowCosmodromeLabels();
        void ShowCosmodromeLabels(bool showCosmodromeLabels);
        bool ShowRingLabels();
        void ShowRingLabels(bool showRingLabels);
