        ...
        renderer.EnqueueTask([weak_this{ get_weak() }, suggestBox, text, isReference]()
            {
                ...
                strong_this->Dispatcher().TryRunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal, [text, source, suggestBox, strong_this, isReference]()
                    {
