...
#if __has_include("SettingsParameter.g.cpp")
#include "SettingsParameter.g.cpp"
#endif
...
{
    SettingsParameter::SettingsParameter(CelestiaAppCore const& appCore, CelestiaRenderer const& renderer, CelestiaAppComponent::AppSettings const& appSettings, Windows::Storage::ApplicationDataContainer const& localSettings, Windows::Foundation::Collections::IVector<hstring> const& availableLanguages)
        : appCore(appCore), renderer(renderer), appSettings(appSettings), localSettings(localSettings), availableLanguages(availableLanguages)
    {
    }

    CelestiaAppCore SettingsParameter::AppCore()
    {
        return appCore;
    }

    CelestiaRenderer SettingsParameter::Renderer()
    {
        return renderer;
    }

    AppSettings SettingsParameter::AppSettings()
    {
        return appSettings;
    }

    Windows::Storage::ApplicationDataContainer SettingsParameter::LocalSettings()
    {
        return localSettings;
    }

    Windows::Foundation::Collections::IVector<hstring> SettingsParameter::AvailableLanguages()
    {
    ...
    {
        itemGroups = single_threaded_observable_vector<CelestiaUWP2::SettingsNavigationItemGroup>();
    }

    void SettingsPage::LoadPage(CelestiaAppCore const& appCore, CelestiaRenderer const& renderer, AppSettings const& appSettings, Windows::Storage::ApplicationDataContainer const& localSettings, Collections::IVector<hstring> const& availableLanguages)
    {
        ...
        itemGroups.Append(CelestiaUWP2::SettingsNavigationItemGroup(LocalizationHelper::Localize(L"Display", L"Display settings"), displaySettingItemGroupItems, false));
        ...
        itemGroups.Append(CelestiaUWP2::SettingsNavigationItemGroup(LocalizationHelper::Localize(L"Guides", L"Grids, labels, orbits, markers"), guidesSettingItemGroupItems, false));
        ...
        itemGroups.Append(CelestiaUWP2::SettingsNavigationItemGroup(LocalizationHelper::Localize(L"Labels", L"Labels to display"), labelsSettingItemGroupItems, false));
        ...
        itemGroups.Append(CelestiaUWP2::SettingsNavigationItemGroup(LocalizationHelper::Localize(L"Renderer", L"In settings"), rendererSettingItemGroupItems, true));
        ...
        itemGroups.Append(CelestiaUWP2::SettingsNavigationItemGroup(LocalizationHelper::Localize(L"Time & Region", L"time and region related settings"), regionSettingItemGroupItems, true));
        ...
        itemGroups.Append(CelestiaUWP2::SettingsNavigationItemGroup(LocalizationHelper::Localize(L"Interaction", L"Settings for interaction"), interactionSettingItemGroupItems, true));
        ...
        itemGroups.Append(CelestiaUWP2::SettingsNavigationItemGroup(LocalizationHelper::Localize(L"Game Controller", L"Settings for game controller"), gamepadSettingItemGroupItems, false));
        ...
        itemGroups.Append(CelestiaUWP2::SettingsNavigationItemGroup(LocalizationHelper::Localize(L"Advanced", L"Advanced setting items"), advancedSettingItemGroupItems, false));

        Nav().SelectedItem(itemGroups.GetAt(0));
    }

    Collections::IObservableVector<CelestiaUWP2::SettingsNavigationItemGroup> SettingsPage::ItemGroups()
    {
        return itemGroups;
    }

    void SettingsPage::NavigationView_SelectionChanged(IInspectable const&, Microsoft::UI::Xaml::Controls::NavigationViewSelectionChangedEventArgs const& args)
    {
        auto selectedItem = args.SelectedItem();
        if (selectedItem == nullptr) return;
        auto itemGroup = selectedItem.try_as<CelestiaUWP2::SettingsNavigationItemGroup>();
        if (itemGroup == nullptr) return;
        ItemGroupSelected(itemGroup);
    }

    void SettingsPage::ItemGroupSelected(CelestiaUWP2::SettingsNavigationItemGroup const& itemGroup)
    {
        Container().Navigate(xaml_typename<CelestiaUWP2::SettingCommonPage>(), CelestiaUWP2::SettingCommonParameter(itemGroup.Items(), itemGroup.ShowRestartHint()));
    }

    void SettingsPage::OnNavigatedTo(Windows::UI::Xaml::Navigation::NavigationEventArgs const& e)
    {
        auto parameter = e.Parameter();
        auto settingsParameter = parameter.as<CelestiaUWP2::SettingsParameter>();
        LoadPage(settingsParameter.AppCore(), settingsParameter.Renderer(), settingsParameter.AppSettings(), settingsParameter.LocalSettings(), settingsParameter.AvailableLanguages());
    }
}
