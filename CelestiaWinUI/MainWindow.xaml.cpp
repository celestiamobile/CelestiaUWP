...
namespace winrt::CelestiaWinUI::implementation
{
    ...
    fire_and_forget MainWindow::MainWindow_Loaded()
    {
        ...
        renderer = CelestiaRenderer(AppSettings().EnableMSAA(), [this, resourcePath, configPath, locale, defaultSettings](int32_t)
            {
    ...
    void MainWindow::PopulateMenuBar(hstring const& resourcePath)
    {
        ...
        AppendItem(fileItem, LocalizationHelper::Localize(L"Run Script\u2026", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                PickScript();
            });
        ...
        AppendItem(fileItem, LocalizationHelper::Localize(L"Capture Image", L"Take a screenshot in Celestia"), [this](IInspectable const&, RoutedEventArgs const&)
            {
                CaptureImage();
        ...
        AppendItem(fileItem, LocalizationHelper::Localize(L"Copy URL", L"Copy current URL to pasteboard"), [this](IInspectable const&, RoutedEventArgs const&)
            {
                CopyURL();
        ...
        AppendItem(fileItem, LocalizationHelper::Localize(L"Paste URL", L"Paste URL from pasteboard"), [this](IInspectable const&, RoutedEventArgs const&)
            {
                PasteURL();
            }, pasteKeyboardAccelerator);
        fileItem.Items().Append(MenuFlyoutSeparator());

        AppendItem(fileItem, LocalizationHelper::Localize(L"Settings", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowSettings();
            });
        fileItem.Items().Append(MenuFlyoutSeparator());
        ...
        if (!isXbox)
        {
            AppendItem(fileItem, LocalizationHelper::Localize(L"Open Custom Folder", L"Open folder for customization"), [this](IInspectable const&, RoutedEventArgs const&)
                {
        ...
        AppendItem(fileItem, LocalizationHelper::Localize(L"Exit", L"Exit Celestia"), [this](IInspectable const&, RoutedEventArgs const&)
            {
        ...
        AppendItem(navigationItem, LocalizationHelper::Localize(L"Select Object", L"Select an object"), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowSelectObject();
            });
        AppendItem(navigationItem, LocalizationHelper::Localize(L"Go to Object", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowGotoObject();
            });
        ...
        AppendItem(navigationItem, LocalizationHelper::Localize(L"Flight Mode", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowObserverMode();
            });
        ...
        AppendItem(toolsItem, LocalizationHelper::Localize(L"Tour Guide", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowTourGuide();
            });
        AppendItem(toolsItem, LocalizationHelper::Localize(L"Star Browser", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowBrowser();
            });
        AppendItem(toolsItem, LocalizationHelper::Localize(L"Eclipse Finder", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowEclipseFinder();
            });
        toolsItem.Items().Append(MenuFlyoutSeparator());
        AppendItem(toolsItem, LocalizationHelper::Localize(L"Get Add-ons", L"Open webpage for downloading add-ons"), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowOnlineAddons();
            });
        AppendItem(toolsItem, LocalizationHelper::Localize(L"Installed Add-ons", L"Open a page for managing installed add-ons"), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowAddonManagement();
            });
        ...
        AppendItem(timeItem, LocalizationHelper::Localize(L"Set Time\u2026", L"Select simulation time"), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowTimeSetting();
            });
        ...
        AppendItem(viewItem, LocalizationHelper::Localize(L"Toggle Fullscreen", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ToggleFullScreen();
        ...
        AppendItem(bookmarkItem, LocalizationHelper::Localize(L"Add Bookmark", L"Add a new bookmark"), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowNewBookmark();
            });
        AppendItem(bookmarkItem, LocalizationHelper::Localize(L"Organize Bookmarks\u2026", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
        ...
        AppendItem(helpItem, LocalizationHelper::Localize(L"Run Demo", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
        ...
        AppendItem(helpItem, LocalizationHelper::Localize(L"OpenGL Info", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                renderer.EnqueueTask([this]()
                    {
                        ...
                        DispatcherQueue().TryEnqueue(Microsoft::UI::Dispatching::DispatcherQueuePriority::Normal, [this, renderInfo]()
                            {
                                ContentDialogHelper::ShowText(Content(), LocalizationHelper::Localize(L"OpenGL Info", L""), renderInfo);
                            });
                    });
            });
        ...
        {
            helpItem.Items().Append(MenuFlyoutSeparator());
            AppendItem(helpItem, LocalizationHelper::Localize(L"Report a Bug", L""), [this](IInspectable const&, RoutedEventArgs const&)
                {
                    ReportBug();
                });
            AppendItem(helpItem, LocalizationHelper::Localize(L"Suggest a Feature", L""), [this](IInspectable const&, RoutedEventArgs const&)
                {
                    SuggestFeature();
                });
        }
        ...
        helpItem.Items().Append(MenuFlyoutSeparator());
        AppendItem(helpItem, LocalizationHelper::Localize(L"Celestia Help", L""), [this](IInspectable const&, RoutedEventArgs const&)
            {
                ShowHelp();
            });
        AppendItem(helpItem, LocalizationHelper::Localize(L"About Celestia", L"System menu item"), [this](IInspectable const&, RoutedEventArgs const&)
            {
        ...
        DispatcherQueue().TryEnqueue(Microsoft::UI::Dispatching::DispatcherQueuePriority::Normal, [this, selection, x, y]()
            {
                ...
                AppendItem(menu, LocalizationHelper::Localize(L"Get Info", L"Action for getting info about current selected object"), [this, selection](IInspectable const&, RoutedEventArgs const&)
                    {
                        ShowInfo(selection);
                    });
                ...
                for (const auto& [name, code] : actions)
                {
                    ...
                    AppendItem(menu, name, [this, selection, copiedCode](IInspectable const&, RoutedEventArgs const&)
                        {
                ...
                {
                    AppendItem(menu, LocalizationHelper::Localize(L"Unmark", L"Unmark an object"), [this, selection](IInspectable const&, RoutedEventArgs const&)
                        {
                            renderer.EnqueueTask([this, selection]()
                                {
                ...
                else
                {
                    ...
                    for (const auto& [name, type] : markers)
                    {
                        ...
                        AppendSubItem(action, name, [this, selection, copiedType](IInspectable const&, RoutedEventArgs const&)
                            {
