...
{
    ResourceManagerUserControl::ResourceManagerUserControl(CelestiaComponent::CelestiaAppCore const& appCore, CelestiaComponent::CelestiaRenderer const& renderer, ResourceManager const& resourceManager, CelestiaWinUI::WebWindowProvider const& windowProvider, CelestiaWinUI::GetAddonHandler const& getAddonHandler) : appCore(appCore), renderer(renderer), resourceManager(resourceManager), windowProvider(windowProvider), installedList(resourceManager, getAddonHandler)
    {
        InitializeComponent();
