...
namespace winrt::CelestiaWinUI::implementation
{
    ...
    private:
        ...
        void Launch(Microsoft::UI::Xaml::LaunchActivatedEventArgs const& launchEvent, Windows::ApplicationModel::Activation::FileActivatedEventArgs const& fileEvent, Windows::ApplicationModel::Activation::IActivatedEventArgs const& urlEvent);
    };
}
