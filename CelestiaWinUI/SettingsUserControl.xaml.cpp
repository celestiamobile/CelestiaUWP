...
namespace winrt::CelestiaWinUI::implementation
{
    ...
    SettingsUserControl::SettingsUserControl(CelestiaAppCore const& appCore, CelestiaRenderer const& renderer, AppSettings const& appSettings, Microsoft::Windows::Storage::ApplicationDataContainer const& localSettings, Collections::IVector<hstring> const& availableLanguages, IReference<int32_t> maximumDisplayFrequency, DisplayInformation const& displayInformation, CelestiaWinUI::SettingParameter const& parameter) : parameter(parameter)
    {
        ...
        std::vector<IInspectable> labelsSettingItems =
        {
            ...
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Plana (Plateaus)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowPlanumLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Chasmata (Canyons)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowChasmaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Paterae (Irregular Craters)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowPateraLabels, localSettings),
            ...
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Rupes (Scarps)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowRupesLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Tesserae (Tile-like Terrain)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowTesseraLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Regiones (Regions)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowRegioLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Chaos (Chaotic Terrain)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowChaosLabels, localSettings),
            ...
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Astra (Radial Features)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowAstrumLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Coronae (Oval Features)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowCoronaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Dorsa (Ridges)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowDorsumLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Fossae (Long Depressions)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowFossaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Catenae (Crater Chains)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowCatenaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Mensae (Flat-Topped Hills)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowMensaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Rimae (Fissures)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowRimaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Undae (Dunes)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowUndaeLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Tholi (Small Domes)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowTholusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Reticula (Reticular Patterns)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowReticulumLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Planitiae (Plains)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowPlanitiaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Lineae (Elongate Markings)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowLineaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Fluctus (Flow Terrain)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowFluctusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Farra (Pancake-like Structures)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowFarrumLabels, localSettings),
            ...
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Insulae (Islands)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowInsulaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Albedo Features", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowAlbedoLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Arcus (Arc-Shaped Features)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowArcusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Cavi (Hollows)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowCavusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Colles (Small Hills)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowCollesLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Faculae (Bright Spots)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowFaculaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Flexus (Cuspate Features)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowFlexusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Flumina (Channels)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowFlumenLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Freta (Straits)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowFretumLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Labes (Landslides)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowLabesLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Labyrinthi (Valley Complexes)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowLabyrinthusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Lacunae (Irregular Depressions)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowLacunaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Lacus (Lakes)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowLacusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Large Ringed Features", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowLargeRingedLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Lobi (Lobate Features)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowLobusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Lingulae (Tongue-Shaped Features)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowLingulaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Maculae (Dark Spots)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowMaculaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Oceani (Oceans)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowOceanusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Paludes (Swamps)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowPalusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Plumes", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowPlumeLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Promontoria (Capes)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowPromontoriumLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Satellite Features", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowSatelliteLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Scopuli (Irregular Scarps)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowScopulusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Serpentes (Serpentine Features)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowSerpensLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Sinus (Bays)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowSinusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Sulci (Parallel Grooves)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowSulcusLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Vastitates (Widespread Lowlands)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowVastitasLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Virgae (Streaks)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowVirgaLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Saxa (Boulders)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowSaxumLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Colla (Necks)", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowCollumLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Cosmodromes", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowCosmodromeLabels, localSettings),
            AppCoreBooleanItem(LocalizationHelper::Localize(L"Rings", L"Location labels"), appCore, renderer, CelestiaComponent::CelestiaSettingBooleanEntry::ShowRingLabels, localSettings),
        ...
        std::vector<IInspectable> rendererSettingItems =
        {
            ...
            AppCoreSingleItem(LocalizationHelper::Localize(L"Dim Clip Factor", L"PSF star setting"), appCore, renderer, CelestiaComponent::CelestiaSettingSingleEntry::StarDimClipFactor, 1.0f, 100.0f, 1.0f, localSettings),
