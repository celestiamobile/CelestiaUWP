...
using CelestiaWinUICs.Utilities;
...
namespace CelestiaWinUICs
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        private async void MainWindow_Loaded()
        {
            ...
            var locale = "en"/*AppSettings.LanguageOverride*/;
            if (locale == null)
                locale = systemLocale;

            await Task.Run(() => CreateExtraFolders());

            mRenderer = new CelestiaRenderer(false/*AppSettings.EnableMSAA*/, () => {
        ...
        private void UpdateScale()
        {
            ...
            var font = fontMap.GetValueOrDefault("en"/*LocalizationHelper.Locale*/, defaultFont);
        ...
        void SetUpGLViewInteractions()
        {
            ...
            {
                if (args.Pointer.PointerDeviceType.Equals(Windows.Devices.Input.PointerDeviceType.Mouse))
                {
        ...
        async Task<string> GetLocale(string LocalePath)
        {
            ...
            return resourceLoader.MainResourceMap.GetValue("CelestiaLanguage").ValueAsString;
        }
